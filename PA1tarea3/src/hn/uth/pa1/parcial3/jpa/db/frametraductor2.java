...
public class frametraductor2 extends javax.swing.JFrame {

    /**
     * Creates new form frametraductor2
     */
    public frametraductor2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Crear  Traduccion");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frametraductor2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frametraductor2().setVisible(true);
            }
        });
    }
